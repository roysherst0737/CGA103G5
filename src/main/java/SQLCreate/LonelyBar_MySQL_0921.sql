...
VALUES ("半價優惠券", "ABCDE123", "針對酒類商品全面半價",0.50, "2022-10-10 00:00:00", "2022-12-25 00:00:00", 0);
...
insert into coupon (`coupon_name`,`coupon_code`,`coupon_content`,`coupon_discount`,
`launch_time`,`off_time`,`status` )
VALUES ("90元優惠券", "ABCDE12345", "針對調酒材料全面折90元", 90, "2022-10-20 00:00:00", "2022-12-25 00:00:00", 0);
...
off_time,
prod_detail )
VALUES (1, "麥卡倫威士忌", 6980, 10, null, "自始至終堅持培養自家雪莉桶的麥卡倫，不惜迢迢萬里路，堅持從西班牙製桶再將橡木桶運回蘇格蘭，顯然是對奢華有「絕對潔癖」的精神。我們也飛往西班牙抽絲剝繭追尋雪莉桶的價值，或許可找到「誰最珍貴」的正解。");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (1, "多利士紅酒", 1500, 6, "2023-01-01 08:10:10", "Miguel Torres Carbo (1909-1991) 對於品質的堅持與開拓國際市場的遠見都是讓TORRES(多利士)成功蛻變成為國際知名酒廠的大功臣之一。");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (1, "唐.胡立歐龍舌蘭", 1680, 5, "2024-01-01 08:10:10", "Don Julio 龍舌蘭酒是墨西哥頂級龍舌蘭酒的領導品牌，也是一位製酒大師60年來始終堅持完美的精心傑作。為了釀造滑順爽口的佳釀，從人工種植龍舌蘭到篩選陳年橡木桶，每個步驟都需嚴謹地遵循傳統。");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (1, "高登琴酒", 880, 16, null, "Gordon’s Gin 高登琴酒主要原料為玉米與大麥，經過一次連續蒸餾後加入來自義大利托斯坎尼的高品質杜松子，胡荽籽與圓當歸根等慎選過後的香料做第二次的共同蒸餾，最後經過第三道蒸餾手續後加以稀釋在裝瓶。");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (2, "雪克杯", 2500, 25, null, "不銹鋼製、高質感的 YUKIWA 波士頓雪克杯，內部大空間可以容納各種酒液、水果、及其他材料，提供創意調飲的最大發揮空間。");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (3, "蘭姆調酒懶人包", 3600, 10, null, "使用高品質百加得蘭姆酒再加上莓果、葡萄汁、青蘋果、檸檬，讓您不用去酒吧就能享受專業蘭姆調酒產品。(一份10入膠囊)");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (3, "威士忌調酒懶人包", 4200, 5, null, "使用高品質麥卡倫威士忌再加上濃縮咖啡、巧克力，讓您不用去酒吧就能享受專業威士忌調酒產品。(一份10入膠囊)");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (3, "琴酒調酒懶人包", 3600, 15, null, "使用高品質高登琴酒再加上橘子、葡萄柚口味苦精，讓您不用去酒吧就能享受專業琴酒調酒產品。(一份10入膠囊)");
INSERT INTO prod (
prod_type_no,
prod_name,
prod_price,
...
off_time,
prod_detail )
VALUES (3, "伏特加調酒懶人包", 2600, 30, null, "使用高品質絕對伏特加再加上新鮮蘋果、肉桂，讓您不用去酒吧就能享受專業伏特加調酒產品。(一份10入膠囊)");
