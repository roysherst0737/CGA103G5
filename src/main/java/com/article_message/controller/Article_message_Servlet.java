...
public class Article_message_Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getAll".equals(action)) {
			/***************************開始查詢資料 ****************************************/
			Article_message_DAO dao = new Article_message_DAO();
			...
			String url = "/article_message/listAllArticle_message_getFromSession.jsp";
		...
		if ("getOne_For_Display".equals(action)) { //來自select_page.jsp的請求
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				/***************************2.開始查詢資料*****************************************/
				Article_message_DAO dao = new Article_message_DAO();
				Article_message_VO article_message_VO = dao.findByPrimaryKey(art_msg_no);
				...
				String url = "/article_message/listOneArticle_message.jsp";
