...
public class Article_message_Service {
	...
	public Article_message_VO addArticle_message(Integer mem_no, Integer frm_art_no, String msg_content) {
	...
	public Article_message_VO updateArticle_message(Integer art_msg_no, Integer mem_no, Integer frm_art_no,
			Timestamp msg_time, String msg_content, Integer msg_status) {
