...
public class Article_message_report_DAO implements Article_message_report_DAO_interface{
	...
	private static final String GET_ONE_STMT = 
		"SELECT art_msg_rpt,mem_no,art_msg_no,rpt_time,rpt_msg_content,mng_no,msg_done_time,msg_status,msg_result,msg_note FROM article_message_report where art_msg_rpt = ?";
	private static final String DELETE = 
		"DELETE FROM article_message_report where art_msg_rpt = ?";
	private static final String UPDATE = 
		"UPDATE article_message_report set mem_no = ?,art_msg_no = ?,rpt_time = ?,rpt_msg_content = ?,mng_no = ?,msg_done_time = ?,msg_status = ?,msg_result = ?,msg_note = ? where art_msg_rpt = ?";
	private static final String CHECK = 
		"UPDATE article_message_report set mng_no = ?,msg_done_time = ?,msg_status = ?,msg_result = ?,msg_note = ? where art_msg_rpt = ?";
