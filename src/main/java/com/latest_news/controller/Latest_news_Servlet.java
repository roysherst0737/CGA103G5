...
//	            }
			...
			//消息狀態  放這裡
				...
				/***************************2.開始修改資料*****************************************/
				Latest_news_Service latest_news_Svc = new Latest_news_Service();
				latest_news_VO = latest_news_Svc.updateLatest_news(latest_news_no, news_content, news_status);
...
//            }
		...
		//消息狀態  放這裡
			...
			latest_news_VO.setNews_status(news_status);
				...
				/***************************2.開始新增資料***************************************/
				Latest_news_Service latest_news_Svc = new Latest_news_Service();
				latest_news_VO = latest_news_Svc.addLatest_news(news_content, news_status);
