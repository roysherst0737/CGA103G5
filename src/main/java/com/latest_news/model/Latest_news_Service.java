...
public class Latest_news_Service {
	...
	public Latest_news_VO addLatest_news(String news_content, Integer news_status, Timestamp news_time) {
	...
	public Latest_news_VO updateLatest_news(Integer latest_news_no,String news_content, Integer news_status, Timestamp news_time) {
