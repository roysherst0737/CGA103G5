	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("findbyemail".equals(action)) {
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req.getRequestDispatcher("/front-end/mem/Forgot_password.jsp");
		...
		if ("sign_up_email".equals(action)) {
			...
			String subject = "朧醴bar活動通知";

			String messageText = req.getParameter("email_content").toString();
