...
import com.question_list.model.Question_list_Service;
import com.question_list.model.Question_list_VO;

@WebServlet("/front-end/act/question_list.do")
public class Question_list_front_Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			List<Question_list_VO> question_listVO = question_listSvc.getAllFromFirmSurveyNo(act_no);

			/*************************** 3.查詢完成,準備轉交(Send the Success view) *************/
			req.setAttribute("question_listVO", question_listVO); // 資料庫取出的empVO物件,存入req
			String url = "/front-end/act/survey.jsp";
...
//			}
//
//			Integer queryString = null;
//			try {
//				queryString = Integer.valueOf(req.getParameter("queryString").trim());
//			} catch (NumberFormatException e) {
//				queryString = 0;
//			}
//
...
//			String url = "listQuestion_list.jsp?" + queryString;
...
//			/*************************** 2.開始刪除資料 ***************************************/
//			Question_list_Service question_listSvc = new Question_list_Service();
//			question_listSvc.deleteQuestion_list(question_no, firm_survey_no);
//
