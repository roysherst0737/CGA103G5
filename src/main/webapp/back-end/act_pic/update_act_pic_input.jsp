...
<title>活動照片修改 - update_act_pic_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>活動照片修改 - update_act_pic_input.jsp</h3>
...
<table>
	<tr>
		<td>活動照片編號:</td>
		<td><input type="TEXT" name="act_pic_no" size="45" 
	...
	<tr>
		...
		<td><input type="file" name="act_pic" size="45"
			 value="<%= (act_picVO==null)? "" : act_picVO.getAct_pic()%>" /></td>
	</tr>
	<tr>
		<td>活動照片名稱:</td>
...
<input type="hidden" name="act_pic_no" value="<%=act_picVO.getAct_pic_no()%>">
