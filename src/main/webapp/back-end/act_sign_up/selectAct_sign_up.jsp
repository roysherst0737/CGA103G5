								...
								<div class="card-body">
									...
									<div class="table-responsive">
										...
										<FORM METHOD="post" ACTION="act_sign_up.do">
											<b>輸入活動報名編號:</b> <input type="text" name="sign_up_no">
											<input type="hidden" name="action" value="getOne_For_Display">
											<input type="submit" value="送出">
										</FORM>

										<jsp:useBean id="act_sign_upSvc" scope="page"
											class="com.act_sign_up.model.Act_sign_up_Service" />
										<FORM METHOD="post" ACTION="act_sign_up.do">
											<b>選擇活動報名編號:</b> <select size="1" name="sign_up_no">
