...
<%
Article_message_VO article_message_VO = (Article_message_VO) request.getAttribute("article_message_VO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<title>員工資料修改 - update_article_message_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>員工資料修改 - update_article_message_input.jsp</h3>
				<h4>
