...
<%
	Article_message_report_VO article_message_report_VO = (Article_message_report_VO) request.getAttribute("article_message_report_VO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<title>留言檢舉資料修改 - update_article_message_report_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>留言檢舉資料修改 - update_article_message_report_input.jsp</h3>
...
<!-- 	</tr> -->
	...
	<tr>
		<td>處理註記:</td>
		<td><input type="TEXT" name="mng_no" size="45"
			 value="<%= (article_message_report_VO==null)? "尚未處理" : article_message_report_VO.getMsg_note()%>" /></td>
	</tr>
