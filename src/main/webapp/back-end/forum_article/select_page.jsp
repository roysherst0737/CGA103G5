				...
				<div class="content-wrapper">
								...
								<div class="mb-3 mb-xl-0 pr-1">
									<div class="dropdown">
										<button style="margin-right: 10px;">
											<a href="listAllForum_article.jsp"><img src="./images/home.png"
					...
					<div class="row  mt-3">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">討論區文章搜尋</h4>
									<div class="table-responsive">
										...
										<FORM METHOD="post" ACTION="forum_article.do">
											<b>選擇文章編號 :</b> <select size="1" name="frm_art_no">
									...
									<div>
										...
										<FORM METHOD="post" ACTION="forum_article.do">
											<a href='listAllForum_article.jsp' class="button">清單列表</a>
										</FORM>
									</div>
								</div>
							</div>
