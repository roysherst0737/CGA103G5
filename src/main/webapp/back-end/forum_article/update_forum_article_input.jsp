...
<%
	Forum_article_VO forum_article_VO = (Forum_article_VO) request.getAttribute("forum_article_VO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
--<%= forum_article_VO==null %>--${forum_article_VO.frm_no}--
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>討論區文章資料修改 - update_forum_article_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>討論區文章資料修改 - update_forum_article_input.jsp</h3>
...
<input type="hidden" name="frm_art_no" value="<%=forum_article_VO.getFrm_art_no()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=forum_article_VO.getArt_time()%>', // value:   new Date(),
