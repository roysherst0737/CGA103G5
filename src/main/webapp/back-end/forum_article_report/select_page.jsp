				...
				<div class="content-wrapper">
					...
					<div class="row  mt-3">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">討論區文章檢舉查詢</h4>
									<div class="table table-responsive">
										...
										<jsp:useBean id="forum_article_report_Svc" scope="page"
											class="com.forum_article_report.model.Forum_article_report_Service" />
										<FORM METHOD="post" ACTION="forum_article_report.do">
											<b>選擇文章檢舉編號 :</b> <select size="1" name="frm_art_rpt_no">
												<c:forEach var="forum_article_report_VO"
										...
										<FORM METHOD="post" ACTION="forum_article_report.do">
											<b>選擇文章編號 :</b> <select size="1" name="frm_art_rpt_no">
												<c:forEach var="forum_article_report_VO"
													items="${forum_article_report_Svc.all}">
