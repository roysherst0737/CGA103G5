...
<%
	Forum_article_report_VO forum_article_report_VO = (Forum_article_report_VO) request.getAttribute("forum_article_report_VO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<title>討論區文章檢舉資料修改 - update_forum_article_report_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>討論區文章檢舉資料修改 - update_forum_article_report_input.jsp</h3>
...
<input type="hidden" name="frm_art_rpt_no" value="<%=forum_article_report_VO.getFrm_art_rpt_no()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=forum_article_report_VO.getRpt_time()%>', // value:   new Date(),
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 	       ...
 	       step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
 	       format:'Y-m-d',         //format:'Y-m-d H:i:s',
 		   value: '<%=forum_article_report_VO.getRpt_done_time()%>', // value:   new Date(),
           //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
           //startDate:	            '2017/07/10',  // 起始日
           //minDate:               '-1970-01-01', // 去除今日(不含)之前
           //maxDate:               '+1970-01-01'  // 去除今日(不含)之後
