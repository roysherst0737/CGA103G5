							...
							<div class="card">
								<div class="card-body">
									...
									<div class="table-responsive">
										...
										<jsp:useBean id="latest_news_Svc" scope="page"
											class="com.latest_news.model.Latest_news_Service" />


										<FORM METHOD="post" ACTION="latest_news.do">
											<b>選擇最新消息編號 :</b> <select size="1" name="latest_news_no">
										...
										<FORM METHOD="post" ACTION="forum.do">
											<a href='addLatest_news.jsp' class="button">新增</a> 	
										</FORM>
										<FORM METHOD="post" ACTION="forum.do">
											<a href='listAllLatest_news.jsp' class="button">修改/刪除</a> 	
										</FORM>
										</div>	
									</div>
								</div>
