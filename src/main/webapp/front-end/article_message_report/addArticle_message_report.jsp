...
%>
--<%=article_message_report_VO == null%>--${article_message_report_VO.art_msg_rpt}--
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title>員工資料新增 - addArticle_message_report.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>員工資料新增 - addArticle_message_report.jsp</h3>
			</td>
			<td>
				<h4>
...
try {
	rpt_time = article_message_report_VO.getRpt_time();
} catch (Exception e) {
	rpt_time = new java.sql.Timestamp(System.currentTimeMillis());
}
java.sql.Timestamp msg_done_time = null;
try {
	msg_done_time = article_message_report_VO.getMsg_done_time();
} catch (Exception e) {
