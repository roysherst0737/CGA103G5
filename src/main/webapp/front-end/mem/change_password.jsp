			...
			<div class="col-lg-4 mx-auto">
				<div class="auth-form-light text-left py-5 px-4 px-sm-5">							
					...
					<c:if test="${not empty errorMsgs}">
						...
						<form class="pt-3" action="<%=request.getContextPath()%>/front-end/mem/MemChangePasswordServlet" method="post">
							<div class="form-group">
								<input type="text" class="form-control form-control-lg"  placeholder="舊密碼" name="oldPassword">
							</div>
							<div class="form-group">
