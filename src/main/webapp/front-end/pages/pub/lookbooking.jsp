...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2>預約查看</h2>
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">預約查看 /</li>
						<li></li>
				...
				<div class="col-lg-12">
					<div class="title-all text-center">
						...
						<div class="main_div">
							...
							<div class="mydiv">
								<div id="day_title1" class="myday div_title"
									style="grid-area: 1/1/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜一</div>
								<div id="day_title2" class="myday div_title"
									style="grid-area: 1/2/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜二</div>
								<div id="day_title3" class="myday div_title"
									style="grid-area: 1/3/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜三</div>
								<div id="day_title4" class="myday div_title"
									style="grid-area: 1/4/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜四</div>
								<div id="day_title5" class="myday div_title"
									style="grid-area: 1/5/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜五</div>
								<div id="day_title6" class="myday div_title "
									style="grid-area: 1/6/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜六</div>
								<div id="day_title7" class="myday div_title "
									style="grid-area: 1/7/auto/auto; height: 33.3px; display: flex; justify-content: center; align-items: center;">禮拜日</div>

								<div id="day1" class="myday" style="grid-area: 2/1/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
								<div id="day2" class="myday" style="grid-area: 2/2/auto/auto;">
									<div>
										<p class="day"></p>
									</div>

								</div>
								<div id="day3" class="myday" style="grid-area: 2/3/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
								<div id="day4" class="myday" style="grid-area: 2/4/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
								<div id="day5" class="myday" style="grid-area: 2/5/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
								<div id="day6" class="myday " style="grid-area: 2/6/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
								<div id="day7" class="myday " style="grid-area: 2/7/auto/auto;">
									<div>
										<p class="day"></p>
									</div>
								</div>
	...
	<script
		src="<%=request.getContextPath()%>/front-end/pages/pub/js/tableBook.js"></script>
