...
<body>
	...
	<div id=top_nav_benner>></div>
		<script>
		$(function() {
			$("#top_nav_benner").load("<%=request.getContextPath()%>/front-end/partials/_mainTop.html");
		});
	</script>
    <!-- !!!!!! 從以下開始修改到footer !!!!!!-->
    ...
    <script>
		$(function() {
			$("footer").load("<%=request.getContextPath()%>/front-end/partials/_footer.html");
		});
	</script>
    <!-- End Footer  -->
